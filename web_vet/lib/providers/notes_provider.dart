...
class VetNote {
  ...
  factory VetNote.fromJson(Map<String, dynamic> j) => VetNote(
        id: j['id'] as String,
...
class VetNotesProvider extends ChangeNotifier {
  final ApiService _api;

  VetNotesProvider({required ApiService api}) : _api = api;
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      _notes = (data['notes'] as List<dynamic>? ?? [])
          .map((e) => VetNote.fromJson(e as Map<String, dynamic>))
          .toList();
    } catch (e) {
      _error = e.toString();
    } finally {
  ...
  Future<bool> update(
    ...
    if (_selectedPetId == null) return false;
    try {
      await _api.put('/pets/$_selectedPetId/notes/$noteId', body: {
