...
class Sidebar extends StatelessWidget {
  ...
  static const List<_SidebarSection> _sections = [
    ...
    _SidebarSection(title: 'Meine Tiere', items: [
      ...
      SidebarItem(label: 'Temperatur', icon: Icons.thermostat_rounded, route: '/temperature'),
      SidebarItem(label: 'Gesundheitspass', icon: Icons.health_and_safety_rounded, route: '/health-passport'),
      SidebarItem(label: 'Kalender', icon: Icons.calendar_month_rounded, route: '/calendar'),
      SidebarItem(label: 'Timeline', icon: Icons.timeline_rounded, route: '/timeline'),
      SidebarItem(label: 'Vergleich', icon: Icons.compare_arrows_rounded, route: '/compare'),
      SidebarItem(label: 'Jahresrückblick', icon: Icons.auto_awesome_rounded, route: '/year-review'),
